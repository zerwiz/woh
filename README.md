...
└── docs/                    # Documentation
    ...
    ├── USAGE-GUIDE.md       # Commands and usage
    ├── CONFIGURATION.md     # Settings and options
    ├── IMPLEMENTATION-GUIDE.md # Architecture
    ├── TROUBLESHOOTING.md   # Common issues
    ├── MIGRATION.md         # Migration guides
    ├── examples/            # Example configurations
    ├── agent-team-eelixir/  # Elixir team implementation
    └── alloy-agent/         # Alloy agent docs
```
...
- **[USAGE-GUIDE](docs/USAGE-GUIDE.md)** - Commands and usage
- **[CONFIGURATION](docs/CONFIGURATION.md)** - Settings and options
- **[IMPLEMENTATION-GUIDE](docs/IMPLEMENTATION-GUIDE.md)** - Architecture
- **[TROUBLESHOOTING](docs/TROUBLESHOOTING.md)** - Common issues
- **[MIGRATION](docs/MIGRATION.md)** - From legacy to Alloy
...
<div style="display: flex; gap: 20px; justify-content: center; margin-top: 20px;">
  ...
  <a href="https://whynotproductions.netlify.app">
    <img src="https://img.shields.io/badge/Website-whynotproductions-blue.svg" alt="Website">
  </a>
</div>
